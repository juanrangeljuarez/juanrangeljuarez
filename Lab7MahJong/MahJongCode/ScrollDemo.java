...
{
	private	static	Dimension	size = new Dimension(Tile.SIDE + Tile.SHAD,
							Tile.SIDE + 2 * Tile.SHAD);
	...
	private		int		width = Tile.SIDE + Tile.SHAD + 6;
	private		int		height = Tile.SIDE + Tile.SHAD;
	private		int		count = 0;
	...
	public ScrollDemo()
	{
		...
		discard[0].setBackground(new Color(254, 254, 254));
		discard[1].setBackground(new Color(254, 254, 254));
