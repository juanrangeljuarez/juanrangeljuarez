...
template <typename T>
CS2420Stack<T>::CS2420Stack(const unsigned int size)
{
    this->capacity = size;
    arr = new T[size];
    currentSize = 0;
...
template <typename T>
void CS2420Stack<T>::push(const T& value)
{
    if(currentSize == capacity)
    {
        cout << "The stack is full"<< endl;
        return;// Alternate bail out condition, or an ejection, seat or door
    }
    else
    {
...
/*!
 * Push the value of an element to the stack
 * @tparam T
 * @param value
 */
template <typename T>
void CS2420Stack<T>::push(T&& value)
{
    if(currentSize == capacity)
    {
        cout << "The stack is full"<< endl;
    ...
    {
        arr[currentSize] = std::move(value);
        currentSize++;
    }
}
 ...
 */
template <typename T>
T CS2420Stack<T>::popAndCopy()
{
    int value = currentSize - 1;
    if(currentSize == 0){
...
/*!
 * Returns a value of the stack
 * @tparam T
 * @return
 */
template <typename T>
T&& CS2420Stack<T>::popAndMove() {
    int value = currentSize - 1;
    if(currentSize == 0){
        cout << "The stack is empty"<< endl;
        throw 1;// Alternate bail out condition, or an ejection, seat or door
    }
    currentSize--;
 ...
 */
template <typename T>
unsigned int CS2420Stack<T>::size()
{
    return currentSize;
}
 ...
 */
template <typename T>
unsigned int CS2420Queue<T>::size()
{
    return currentSize;
}
 ...
 */
template <typename T>
void CS2420Queue<T>::pushBack(const T &value)
{
    if(currentSize == capacity)
    {
        cout << "The stack is full"<< endl;
...
void testCS2420Stack() {
    ...
    sstack->push(temp);                 // Push marker backIndex in
    ...
    temp = std::move(sstack->popAndMove());             // Move the string backIndex out of the sstack

    // See if we have it backIndex
...
void testCS2420Queue() {
    ...
    //Test adding and removing backIndex and forth
    pQueue->pushBack("penny");
